...
(function () {
  ...
  // True only when transcriptEl holds a successfully loaded transcript (not an error message)
  ...
  async function fetchTranscript() {
    ...
    const fetchJsonp = (baseUrl, targetUrl) => {
      return new Promise((resolve, reject) => {
        ...
        // Declare cleanup before referencing it in callbacks to avoid TDZ errors
        const cleanup = () => {
